...
app.use('/funkos/:user', (req, res, next) => {
...
app.post('/funkos/:user', async (req, res) => {
    try {
...
app.get('/funkos/:user', async (req, res) => {
    try {
        const { user } = req.params;
        const manager = new FunkoManager(user);
...
app.get('/funkos/:user/:id', async (req, res) => {
    try {
...
app.patch('/funkos/:user/:id', async (req, res) => {
    try {
        const { user, id } = req.params;
        const funkoData = req.body;
        const numericId = Number(id);
...
app.delete('/funkos/:user/:id', async (req, res) => {
    try {
        const { user, id } = req.params;
        const numericId = Number(id);
        if (isNaN(numericId)) {
